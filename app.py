    ...
    **How it Works:**
    ...
    if st.session_state.combined_synthetic_data is None:
        ...
        if st.button("Apply Missing Data Handling", help="Apply the selected option to missing values."):
            st.session_state.post_processed_data = handle_missing_data(st.session_state.post_processed_data or st.session_state.combined_synthetic_data.copy(), missing_option)
